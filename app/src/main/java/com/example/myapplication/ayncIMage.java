...
public class ayncIMage   extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aync_image);
     ...
     btnPlayMusic.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
             ...
             if (file.exists()) {
                 Toast.makeText(getApplicationContext(), "File already exist " + "at "+ Environment.getExternalStorageDirectory()
                         .getPath() +
